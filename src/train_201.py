...
def parse_args():
    ...
    script_name = os.getcwd() + '\\train_201.py'
    model_name_or_path = '../bart-large'
    output_dir = '../model_output/Newsela-201'
    train_file = '../data/ppnmt/train201.csv'
    ...
    training_args.save_steps = 8000  # 保存的步长
    ...
    training_args.eval_steps = 8000
    training_args.max_steps = 8001
...
def main():
    ...
    def compute_metrics(eval_preds):
        ...
        df.to_csv(f'../output/model_pred_simp/result_201/result_{step_time}.csv', index = False, sep = ',')
...
if __name__ == "__main__":
    ...
    SIMP4 = 0
    BEST_SARI_MEAN = 0
    os.makedirs('../output/model_pred_simp/result_201', exist_ok = True)
    logger_writer = open('../output/log.txt', 'a+', encoding = 'utf-8')
    result_writer = open('../output/model_pred_simp/result_201/res_201.jsonlines', 'a+', encoding = "utf-8")
    main()
